        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            {lubricantProducts.map((product, index) => (
              <div
                key={index}
                className="p-8 bg-background border border-border rounded-lg card-hover relative overflow-hidden"
              >
                {product.sole && (
                  <div className="absolute top-4 right-4 px-3 py-1 bg-primary text-primary-foreground text-xs font-bold rounded">
                    SOLE AGENT
                  </div>
                )}
                ...
                <p className="text-sm text-primary mb-4">{product.origin}</p>
